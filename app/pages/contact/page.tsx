...
export default function Contact() { //temel bir iletişim formu

  return (
    <div className="isolate bg-white px-6 py-2">
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-2xl font-bold tracking-tight text-blue-600 sm:text-2xl">İletişim Formu</h2>
      </div>
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-10">
        ...
        <div className="mt-10">
          <button
            type="submit"
            className="block w-full rounded-md bg-blue-900 px-3.5 py-2.5 text-center text-sm font-semibold text-white  hover:bg-white border hover:text-blue-900 hover:border-blue-900"
          >
            Gönder
          </button>
        </div>
